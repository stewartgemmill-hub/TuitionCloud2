...
{
    public class SP_FETCH_WORD_ROWNUMBER
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private SP_FETCH_WORD_ROWNUMBER_Result res;
        public SP_FETCH_WORD_ROWNUMBER(SP_FETCH_WORD_ROWNUMBER_Result obj) { res = obj; }
