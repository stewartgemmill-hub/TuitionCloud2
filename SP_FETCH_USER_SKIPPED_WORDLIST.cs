...
{
    public class SP_FETCH_USER_SKIPPED_WORDLIST
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private SP_FETCH_USER_SKIPPED_WORDLIST_Result res;
        public SP_FETCH_USER_SKIPPED_WORDLIST(SP_FETCH_USER_SKIPPED_WORDLIST_Result obj) { res = obj; }
