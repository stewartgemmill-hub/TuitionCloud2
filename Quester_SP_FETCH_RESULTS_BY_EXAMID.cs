...
{
    public class Quester_SP_FETCH_RESULTS_BY_EXAMID
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private Quester_SP_FETCH_RESULTS_BY_EXAMID_Result res;
        public Quester_SP_FETCH_RESULTS_BY_EXAMID(Quester_SP_FETCH_RESULTS_BY_EXAMID_Result obj) { res = obj; }
        ...
        public bool ISCORRECT { get { return res.ISCORRECT ?? false; } }
