...
{
    public class Quester_SP_FETCH_EXAM_WORDS_Share
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private Quester_SP_FETCH_EXAM_WORDS_Share_Result res;
        public Quester_SP_FETCH_EXAM_WORDS_Share(Quester_SP_FETCH_EXAM_WORDS_Share_Result obj) { res = obj; }
