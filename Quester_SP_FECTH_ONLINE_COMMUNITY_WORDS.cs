...
{
    public class Quester_SP_FECTH_ONLINE_COMMUNITY_WORDS
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private Quester_SP_FECTH_ONLINE_COMMUNITY_WORDS_Result res;
        public Quester_SP_FECTH_ONLINE_COMMUNITY_WORDS(Quester_SP_FECTH_ONLINE_COMMUNITY_WORDS_Result obj) { res = obj; }
