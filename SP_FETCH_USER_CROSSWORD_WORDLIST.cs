...
{
    public class SP_FETCH_USER_CROSSWORD_WORDLIST
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private SP_FETCH_USER_CROSSWORD_WORDLIST_Result res;
        public SP_FETCH_USER_CROSSWORD_WORDLIST(SP_FETCH_USER_CROSSWORD_WORDLIST_Result obj) { res = obj; }
