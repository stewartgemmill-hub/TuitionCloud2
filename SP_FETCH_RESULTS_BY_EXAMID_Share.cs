...
{
    public class SP_FETCH_RESULTS_BY_EXAMID_Share
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private SP_FETCH_RESULTS_BY_EXAMID_Share_Result res;
        public SP_FETCH_RESULTS_BY_EXAMID_Share(SP_FETCH_RESULTS_BY_EXAMID_Share_Result obj) { res = obj; }
