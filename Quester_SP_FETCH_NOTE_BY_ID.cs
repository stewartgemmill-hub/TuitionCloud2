...
{
    public class Quester_SP_FETCH_NOTE_BY_ID
    {
          private TutionCloudEntities _context = new TutionCloudEntities();
          private Quester_SP_FETCH_NOTE_BY_ID_Result res;
          public Quester_SP_FETCH_NOTE_BY_ID(Quester_SP_FETCH_NOTE_BY_ID_Result obj) { res = obj; }
