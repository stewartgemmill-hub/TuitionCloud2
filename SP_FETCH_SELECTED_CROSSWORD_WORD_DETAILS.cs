...
{
    public class SP_FETCH_SELECTED_CROSSWORD_WORD_DETAILS
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private SP_FETCH_SELECTED_CROSSWORD_WORD_DETAILS_Result res;
        public SP_FETCH_SELECTED_CROSSWORD_WORD_DETAILS(SP_FETCH_SELECTED_CROSSWORD_WORD_DETAILS_Result obj) { res = obj; }
