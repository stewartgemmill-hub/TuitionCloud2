...
{
    public class SP_FETCH_EXAM_WORDS_Share
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private SP_FETCH_EXAM_WORDS_Share_Result res;
        public SP_FETCH_EXAM_WORDS_Share(SP_FETCH_EXAM_WORDS_Share_Result obj) { res = obj; }
