...
{
    public class Quester_SP_FETCH_TOTAL_WORDLIST
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private Quester_SP_FETCH_TOTAL_WORDLIST_Result res;
        public Quester_SP_FETCH_TOTAL_WORDLIST(Quester_SP_FETCH_TOTAL_WORDLIST_Result obj) { res = obj; }
