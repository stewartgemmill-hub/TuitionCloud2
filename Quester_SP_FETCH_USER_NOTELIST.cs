...
{
    public class Quester_SP_FETCH_USER_NOTELIST
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private Quester_SP_FETCH_USER_NOTELIST_Result res;
        public Quester_SP_FETCH_USER_NOTELIST(Quester_SP_FETCH_USER_NOTELIST_Result obj) { res = obj; }
