...
{
    public class Quester_SP_FETCH_USER_WORDLIST_Folder_Search
    {
        private TutionCloudEntities _context = new TutionCloudEntities();
        private Quester_SP_FETCH_USER_WORDLIST_Folder_Search_Result res;
        public Quester_SP_FETCH_USER_WORDLIST_Folder_Search(Quester_SP_FETCH_USER_WORDLIST_Folder_Search_Result obj) { res = obj; }
